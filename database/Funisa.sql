...
INSERT INTO segnalazione(tipo,descrizione,utenteEmail) VALUES('Segnalazione','Segnalazione1','cliente@cliente.com')
INSERT INTO segnalazione(tipo,descrizione,utenteEmail) VALUES('Segnalazione','Segnalazione2','cliente@cliente.com')
INSERT INTO segnalazione(tipo,descrizione,utenteEmail) VALUES('Segnalazione','Segnalazione3','cliente@cliente.com')
...
CREATE TABLE recensione(
    ...
    utenteEmail VARCHAR(50) NOT NULL PRIMARY KEY,
    FOREIGN KEY (UtenteEmail) REFERENCES utente(email) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE categoria(
    ...
    tipoGenerico VARCHAR(30) NOT NULL,
    prezzo FLOAT NOT NULL,
...
INSERT INTO categoria VALUES('PS5','Console',5,'PROVA','data:image/jpeg;base64,')
INSERT INTO categoria VALUES('Oculus','VR',5,'PROVA','data:image/jpeg;base64,')
INSERT INTO categoria VALUES('PROVA','VR',5,'PROVA','data:image/jpeg;base64,')
...
INSERT INTO prenotazione(dataPrenotazione,fasciaOraria,utenteEmail,postazioneId,prezzo) VALUES('2020-02-12','12/14','titolare@titolare.com',5,5)
...
/*LISTA POSTAZIONI DISPONIBILI
  SELECT * FROM postazione p 
