...
public class UtenteBean {
	...
	public UtenteBean(String email, String nome, String cognome, String username, Ruolo ruolo, boolean stato,
			String codiceVerifica, String password, String img) {
		super();
		this.email = email;
		this.nome = nome;
		this.cognome = cognome;
	...
	/**
	 * Questo metodo è stato creato per codificare una password passata come
	 * plain-text in una codificata utilizzando l'algoritmo SHA-256
	 * 
