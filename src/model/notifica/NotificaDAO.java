...
/**
 * @category Permette di effettuare gli accessi al database della tabella notifica
 * 
 * */
public class NotificaDAO implements ModelInterface<NotificaBean, Integer> {
	 ...
	 * <br>Non utilizzare questo metodo per salvare le notifiche</br>
	 * */
	@Override
	...
	/**
	 * @category permette di salvare la notifica all'interno del database collengandola agli utenti
	 * 
	...
	/**
	 * @category permette di impostare isRead di uno specifico utente su una notifica
	 * 
