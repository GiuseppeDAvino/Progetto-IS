...
class TestPostazione { 
	...
	@Test
	void testRicercaPostazioneConCategoriaEsistente()   {
	...
	void testCambiaDisponibilit‡() {
		assertEquals(true, dao.cambiaDisponibilit‡(postazioneConCategoriaEsistente));
	}
	@Test
	void testEliminaPostazioneTramiteId() {
		assertEquals(true, dao.doDelete(postazioneConCategoriaEsistente.getId()));
	}
	@Test
